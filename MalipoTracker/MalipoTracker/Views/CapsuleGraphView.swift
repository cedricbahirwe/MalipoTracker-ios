...
//  MalipoTracker
//
//  Created by Cédric Bahirwe on 20/07/2021.
//
    ...
    var body: some View {
        ...
        ZStack {
            ...
            VStack {
                ...
                CapsuleGraphView(data: data[dataPicker]!, maxValueInData: data[dataPicker]!.max()!, spacing: 4, capsuleColor: dataBarColor[dataPicker]!)
